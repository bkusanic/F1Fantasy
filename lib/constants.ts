...
export const DRIVERS_2025: Driver[] = [
  ...
  // Mercedes
  { id: "rus", name: "George Russell",    shortName: "RUS", team: "mercedes",  price: 27.7, driverNumber: 63 },
  { id: "ant", name: "Kimi Antonelli",    shortName: "ANT", team: "mercedes",  price: 26.3, driverNumber: 12 },
  // Ferrari
  { id: "lec", name: "Charles Leclerc",   shortName: "LEC", team: "ferrari",   price: 24.1, driverNumber: 16 },
  { id: "ham", name: "Lewis Hamilton",    shortName: "HAM", team: "ferrari",   price: 25.2, driverNumber: 44 }, // ↑ was 22.0
  // Red Bull
  { id: "ver", name: "Max Verstappen",    shortName: "VER", team: "redbull",   price: 27.4, driverNumber: 33 },
  { id: "had", name: "Isack Hadjar",      shortName: "HAD", team: "redbull",   price: 10.0, driverNumber: 6  }, // vratio se u Red Bull
  // Williams
  { id: "alb", name: "Alex Albon",        shortName: "ALB", team: "williams",  price: 5.8, driverNumber: 23 },
  { id: "sai", name: "Carlos Sainz",      shortName: "SAI", team: "williams",  price: 9.6, driverNumber: 55 },
  // Racing Bulls
  { id: "law", name: "Liam Lawson",       shortName: "LAW", team: "rb",        price: 14.9,  driverNumber: 30 }, // vratio se u Racing Bulls
  { id: "lin", name: "Arvid Lindblad",    shortName: "LIN", team: "rb",        price: 8.0,  driverNumber: 41 },
  { id: "tsu", name: "Yuki Tsunoda",      shortName: "TSU", team: "rb",        price: 9.9,  driverNumber: 22 }, // NE VOZI (UNAVAILABLE_DRIVERS) — ostaje u listi jer ga postojeći timovi mogu imati
  // Aston Martin
  { id: "alo", name: "Fernando Alonso",   shortName: "ALO", team: "aston",     price: 7.0,  driverNumber: 14 },
  { id: "str", name: "Lance Stroll",      shortName: "STR", team: "aston",     price: 3.0,  driverNumber: 18 }, // ↓ was 7.5
  // Haas
  { id: "oco", name: "Esteban Ocon",      shortName: "OCO", team: "haas",      price: 9.5, driverNumber: 31 }, // ↑ was 8.0
  { id: "bea", name: "Oliver Bearman",    shortName: "BEA", team: "haas",      price: 6.4,  driverNumber: 87 },
  // Audi (ex-Sauber)
  { id: "hul", name: "Nico Hülkenberg",   shortName: "HUL", team: "audi",      price: 4.2,  driverNumber: 27 },
  { id: "bor", name: "Gabriel Bortoleto", shortName: "BOR", team: "audi",      price: 8.6,  driverNumber: 5  },
  // Alpine
  { id: "gas", name: "Pierre Gasly",      shortName: "GAS", team: "alpine",    price: 12.2,  driverNumber: 10 },
  { id: "col", name: "Franco Colapinto",  shortName: "COL", team: "alpine",    price: 10.4,  driverNumber: 43 }, // ↑ was 7.0
  // Cadillac (new team)
...
export const CONSTRUCTORS_2025: Constructor[] = [
  { id: "mclaren",  name: "McLaren",       shortName: "MCL", price: 31.6, drivers: ["nor", "pia"] },
  { id: "mercedes", name: "Mercedes",      shortName: "MER", price: 33.2, drivers: ["rus", "ant"] },
  { id: "ferrari",  name: "Ferrari",       shortName: "FER", price: 27.2, drivers: ["lec", "ham"] },
  { id: "redbull",  name: "Red Bull",      shortName: "RBR", price: 31.5, drivers: ["ver", "had"] },
  { id: "williams", name: "Williams",      shortName: "WIL", price: 13.7, drivers: ["alb", "sai"] },
  { id: "rb",       name: "Racing Bulls",  shortName: "RB",  price: 14.1,  drivers: ["law", "lin"] },
  { id: "aston",    name: "Aston Martin",  shortName: "AMR", price: 6.9,  drivers: ["alo", "str"] },
  { id: "haas",     name: "Haas",          shortName: "HAA", price: 10.8,  drivers: ["oco", "bea"] },
  { id: "audi",     name: "Audi",          shortName: "AUD", price: 8.0,  drivers: ["hul", "bor"] },
  { id: "alpine",   name: "Alpine",        shortName: "ALP", price: 19.2,  drivers: ["gas", "col"] },
