...
// Zadnje ažuriranje: 23. 09. 2026. (auto-sync, gameday 15)

export const DRIVERS_2025: Driver[] = [
  // McLaren
  { id: "nor", name: "Lando Norris",      shortName: "NOR", team: "mclaren",   price: 27.0, driverNumber: 1  },
  { id: "pia", name: "Oscar Piastri",     shortName: "PIA", team: "mclaren",   price: 24.1, driverNumber: 81 },
  // Mercedes
  { id: "rus", name: "George Russell",    shortName: "RUS", team: "mercedes",  price: 27.8, driverNumber: 63 },
  { id: "ant", name: "Kimi Antonelli",    shortName: "ANT", team: "mercedes",  price: 26.6, driverNumber: 12 },
  // Ferrari
  { id: "lec", name: "Charles Leclerc",   shortName: "LEC", team: "ferrari",   price: 24.0, driverNumber: 16 },
  { id: "ham", name: "Lewis Hamilton",    shortName: "HAM", team: "ferrari",   price: 24.9, driverNumber: 44 }, // ↑ was 22.0
  // Red Bull
  { id: "ver", name: "Max Verstappen",    shortName: "VER", team: "redbull",   price: 27.3, driverNumber: 33 },
  { id: "had", name: "Isack Hadjar",      shortName: "HAD", team: "redbull",   price: 14.5, driverNumber: 6  }, // vratio se u Red Bull
  // Williams
  { id: "alb", name: "Alex Albon",        shortName: "ALB", team: "williams",  price: 6.4, driverNumber: 23 },
  { id: "sai", name: "Carlos Sainz",      shortName: "SAI", team: "williams",  price: 9.0, driverNumber: 55 },
  // Racing Bulls
  { id: "law", name: "Liam Lawson",       shortName: "LAW", team: "rb",        price: 15.1,  driverNumber: 30 }, // vratio se u Racing Bulls
  { id: "lin", name: "Arvid Lindblad",    shortName: "LIN", team: "rb",        price: 8.2,  driverNumber: 41 },
  ...
  // Aston Martin
  { id: "alo", name: "Fernando Alonso",   shortName: "ALO", team: "aston",     price: 6.8,  driverNumber: 14 },
  { id: "str", name: "Lance Stroll",      shortName: "STR", team: "aston",     price: 3.0,  driverNumber: 18 }, // ↓ was 7.5
  // Haas
  { id: "oco", name: "Esteban Ocon",      shortName: "OCO", team: "haas",      price: 8.9, driverNumber: 31 }, // ↑ was 8.0
  { id: "bea", name: "Oliver Bearman",    shortName: "BEA", team: "haas",      price: 5.8,  driverNumber: 87 },
  // Audi (ex-Sauber)
  { id: "hul", name: "Nico Hülkenberg",   shortName: "HUL", team: "audi",      price: 4.8,  driverNumber: 27 },
  { id: "bor", name: "Gabriel Bortoleto", shortName: "BOR", team: "audi",      price: 8.4,  driverNumber: 5  },
  // Alpine
  { id: "gas", name: "Pierre Gasly",      shortName: "GAS", team: "alpine",    price: 12.0,  driverNumber: 10 },
  { id: "col", name: "Franco Colapinto",  shortName: "COL", team: "alpine",    price: 10.6,  driverNumber: 43 }, // ↑ was 7.0
  // Cadillac (new team)
...
export const CONSTRUCTORS_2025: Constructor[] = [
  { id: "mclaren",  name: "McLaren",       shortName: "MCL", price: 31.9, drivers: ["nor", "pia"] },
  { id: "mercedes", name: "Mercedes",      shortName: "MER", price: 33.5, drivers: ["rus", "ant"] },
  { id: "ferrari",  name: "Ferrari",       shortName: "FER", price: 27.5, drivers: ["lec", "ham"] },
  { id: "redbull",  name: "Red Bull",      shortName: "RBR", price: 31.8, drivers: ["ver", "had"] },
  { id: "williams", name: "Williams",      shortName: "WIL", price: 14.0, drivers: ["alb", "sai"] },
  { id: "rb",       name: "Racing Bulls",  shortName: "RB",  price: 14.7,  drivers: ["law", "lin"] },
  ...
  { id: "audi",     name: "Audi",          shortName: "AUD", price: 8.6,  drivers: ["hul", "bor"] },
  { id: "alpine",   name: "Alpine",        shortName: "ALP", price: 19.5,  drivers: ["gas", "col"] },
