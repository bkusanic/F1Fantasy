...
// Zadnje ažuriranje: 18. 08. 2026. (admin)
...
export const DRIVERS_2025: Driver[] = [
  ...
  { id: "had", name: "Isack Hadjar",      shortName: "HAD", team: "redbull",   price: 14.5, driverNumber: 6  },
  // Williams
  ...
  // Racing Bulls
  { id: "law", name: "Liam Lawson",       shortName: "LAW", team: "rb",        price: 10.3,  driverNumber: 30 },
  { id: "lin", name: "Arvid Lindblad",    shortName: "LIN", team: "rb",        price: 8.0,  driverNumber: 41 }, // ↓ was 7.0
  // Aston Martin
...
export const CONSTRUCTORS_2025: Constructor[] = [
  ...
  { id: "redbull",  name: "Red Bull",      shortName: "RBR", price: 30.9, drivers: ["ver", "had"] }, // ↑ was 22.0
  { id: "williams", name: "Williams",      shortName: "WIL", price: 13.0, drivers: ["alb", "sai"] },
  { id: "rb",       name: "Racing Bulls",  shortName: "RB",  price: 12.9,  drivers: ["law", "lin"] },
