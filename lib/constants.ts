...
// Zadnje ažuriranje: 02. 09. 2026. (admin)
...
export const DRIVERS_2025: Driver[] = [
  ...
  // Mercedes
  { id: "rus", name: "George Russell",    shortName: "RUS", team: "mercedes",  price: 27.6, driverNumber: 63 },
  { id: "ant", name: "Kimi Antonelli",    shortName: "ANT", team: "mercedes",  price: 26.0, driverNumber: 12 },
  // Ferrari
  { id: "lec", name: "Charles Leclerc",   shortName: "LEC", team: "ferrari",   price: 24.2, driverNumber: 16 },
  { id: "ham", name: "Lewis Hamilton",    shortName: "HAM", team: "ferrari",   price: 25.1, driverNumber: 44 }, // ↑ was 22.0
  // Red Bull
  { id: "ver", name: "Max Verstappen",    shortName: "VER", team: "redbull",   price: 27.5, driverNumber: 33 },
  ...
  { id: "sai", name: "Carlos Sainz",      shortName: "SAI", team: "williams",  price: 9.8, driverNumber: 55 },
  // Racing Bulls
  { id: "law", name: "Liam Lawson",       shortName: "LAW", team: "redbull",   price: 14.3,  driverNumber: 30 }, // R9: mijenja Hadjara u Red Bullu
  { id: "lin", name: "Arvid Lindblad",    shortName: "LIN", team: "rb",        price: 7.8,  driverNumber: 41 },
  { id: "tsu", name: "Yuki Tsunoda",      shortName: "TSU", team: "rb",        price: 9.7,  driverNumber: 22 }, // R9: mijenja Lawsona — PROVJERI CIJENU u builderu!
  // Aston Martin
  ...
  // Audi (ex-Sauber)
  { id: "hul", name: "Nico Hülkenberg",   shortName: "HUL", team: "audi",      price: 3.6,  driverNumber: 27 },
  { id: "bor", name: "Gabriel Bortoleto", shortName: "BOR", team: "audi",      price: 8.0,  driverNumber: 5  },
  // Alpine
  { id: "gas", name: "Pierre Gasly",      shortName: "GAS", team: "alpine",    price: 12.4,  driverNumber: 10 },
  { id: "col", name: "Franco Colapinto",  shortName: "COL", team: "alpine",    price: 10.6,  driverNumber: 43 }, // ↑ was 7.0
  // Cadillac (new team)
  { id: "per", name: "Sergio Pérez",      shortName: "PER", team: "cadillac",  price: 3.2,  driverNumber: 11 },
...
export const CONSTRUCTORS_2025: Constructor[] = [
  { id: "mclaren",  name: "McLaren",       shortName: "MCL", price: 31.3, drivers: ["nor", "pia"] },
  { id: "mercedes", name: "Mercedes",      shortName: "MER", price: 32.9, drivers: ["rus", "ant"] },
  { id: "ferrari",  name: "Ferrari",       shortName: "FER", price: 26.9, drivers: ["lec", "ham"] },
  { id: "redbull",  name: "Red Bull",      shortName: "RBR", price: 31.2, drivers: ["ver", "law"] }, // R9: LAW umjesto HAD
  { id: "williams", name: "Williams",      shortName: "WIL", price: 13.2, drivers: ["alb", "sai"] },
  { id: "rb",       name: "Racing Bulls",  shortName: "RB",  price: 13.5,  drivers: ["tsu", "lin"] }, // R9: TSU umjesto LAW
  ...
  { id: "audi",     name: "Audi",          shortName: "AUD", price: 7.4,  drivers: ["hul", "bor"] },
  { id: "alpine",   name: "Alpine",        shortName: "ALP", price: 18.9,  drivers: ["gas", "col"] },
