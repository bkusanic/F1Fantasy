...
// Zadnje ažuriranje: 22. 07. 2026. (admin)

export const DRIVERS_2025: Driver[] = [
  // McLaren
  { id: "nor", name: "Lando Norris",      shortName: "NOR", team: "mclaren",   price: 25.8, driverNumber: 1  },
  { id: "pia", name: "Oscar Piastri",     shortName: "PIA", team: "mclaren",   price: 24.7, driverNumber: 81 },
  // Mercedes
  { id: "rus", name: "George Russell",    shortName: "RUS", team: "mercedes",  price: 28.0, driverNumber: 63 },
  { id: "ant", name: "Kimi Antonelli",    shortName: "ANT", team: "mercedes",  price: 25.6, driverNumber: 12 },
  // Ferrari
  { id: "lec", name: "Charles Leclerc",   shortName: "LEC", team: "ferrari",   price: 23.6, driverNumber: 16 },
  { id: "ham", name: "Lewis Hamilton",    shortName: "HAM", team: "ferrari",   price: 24.9, driverNumber: 44 }, // ↑ was 22.0
  // Red Bull
  { id: "ver", name: "Max Verstappen",    shortName: "VER", team: "redbull",   price: 27.7, driverNumber: 33 },
  { id: "had", name: "Isack Hadjar",      shortName: "HAD", team: "redbull",   price: 13.9, driverNumber: 6  },
  // Williams
  { id: "alb", name: "Alex Albon",        shortName: "ALB", team: "williams",  price: 6.4, driverNumber: 23 },
  { id: "sai", name: "Carlos Sainz",      shortName: "SAI", team: "williams",  price: 10.2, driverNumber: 55 },
  // Racing Bulls
  { id: "law", name: "Liam Lawson",       shortName: "LAW", team: "rb",        price: 9.7,  driverNumber: 30 },
  { id: "lin", name: "Arvid Lindblad",    shortName: "LIN", team: "rb",        price: 7.4,  driverNumber: 41 }, // ↓ was 7.0
  // Aston Martin
  ...
  // Haas
  { id: "oco", name: "Esteban Ocon",      shortName: "OCO", team: "haas",      price: 10.5, driverNumber: 31 }, // ↑ was 8.0
  { id: "bea", name: "Oliver Bearman",    shortName: "BEA", team: "haas",      price: 7.4,  driverNumber: 87 },
  // Audi (ex-Sauber)
  { id: "hul", name: "Nico Hülkenberg",   shortName: "HUL", team: "audi",      price: 3.0,  driverNumber: 27 },
  { id: "bor", name: "Gabriel Bortoleto", shortName: "BOR", team: "audi",      price: 7.2,  driverNumber: 5  },
  // Alpine
  { id: "gas", name: "Pierre Gasly",      shortName: "GAS", team: "alpine",    price: 12.8,  driverNumber: 10 },
  { id: "col", name: "Franco Colapinto",  shortName: "COL", team: "alpine",    price: 11.0,  driverNumber: 43 }, // ↑ was 7.0
  // Cadillac (new team)
  { id: "per", name: "Sergio Pérez",      shortName: "PER", team: "cadillac",  price: 4.4,  driverNumber: 11 },
...
export const CONSTRUCTORS_2025: Constructor[] = [
  { id: "mclaren",  name: "McLaren",       shortName: "MCL", price: 30.7, drivers: ["nor", "pia"] },
  { id: "mercedes", name: "Mercedes",      shortName: "MER", price: 32.3, drivers: ["rus", "ant"] },
  { id: "ferrari",  name: "Ferrari",       shortName: "FER", price: 26.3, drivers: ["lec", "ham"] },
  { id: "redbull",  name: "Red Bull",      shortName: "RBR", price: 30.6, drivers: ["ver", "had"] }, // ↑ was 22.0
  { id: "williams", name: "Williams",      shortName: "WIL", price: 13.2, drivers: ["alb", "sai"] },
  { id: "rb",       name: "Racing Bulls",  shortName: "RB",  price: 12.3,  drivers: ["law", "lin"] },
  ...
  { id: "audi",     name: "Audi",          shortName: "AUD", price: 6.2,  drivers: ["hul", "bor"] },
  { id: "alpine",   name: "Alpine",        shortName: "ALP", price: 18.5,  drivers: ["gas", "col"] },
