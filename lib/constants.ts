...
// Zadnje ažuriranje: 10. 09. 2026. (admin)
...
export const DRIVERS_2025: Driver[] = [
  ...
  // Racing Bulls
  { id: "law", name: "Liam Lawson",       shortName: "LAW", team: "redbull",   price: 14.9,  driverNumber: 30 }, // R9: mijenja Hadjara u Red Bullu
  { id: "lin", name: "Arvid Lindblad",    shortName: "LIN", team: "rb",        price: 8.0,  driverNumber: 41 },
  { id: "tsu", name: "Yuki Tsunoda",      shortName: "TSU", team: "rb",        price: 9.9,  driverNumber: 22 }, // R9: mijenja Lawsona — PROVJERI CIJENU u builderu!
  // Aston Martin
...
export const CONSTRUCTORS_2025: Constructor[] = [
  ...
  { id: "redbull",  name: "Red Bull",      shortName: "RBR", price: 31.5, drivers: ["ver", "law"] }, // R9: LAW umjesto HAD
  { id: "williams", name: "Williams",      shortName: "WIL", price: 13.7, drivers: ["alb", "sai"] },
  { id: "rb",       name: "Racing Bulls",  shortName: "RB",  price: 14.1,  drivers: ["tsu", "lin"] }, // R9: TSU umjesto LAW
